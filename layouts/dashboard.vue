<template>
         <div class="min-h-screen bg-gray-50">
                                    ...
                                    <div class="flex items-center gap-4">
                                             ...
                                             <div class="flex items-center">
                                                      <span class="text-xl font-bold"><span
                                                                        class="text-blue-600">Key</span><span
                                                                        class="text-secondary-600">lity</span></span>
                                             </div>
                                             <div class="relative hidden md:flex items-center gap-4">
                                                      ...
                                                      <div class="flex items-center bg-gray-100 rounded-full p-1">
                                                               <button @click="mode = 'candidat'"
                                                                        class="px-4 py-2 rounded-full text-sm font-medium transition-all duration-200"
                                                                        :class="mode === 'candidat' ? 'bg-white text-blue-600 shadow' : 'text-gray-600 hover:text-gray-800'">
                                                                        Candidat
                                                               </button>
                                                               <button @click="mode = 'annonceur'"
                                                                        class="px-4 py-2 rounded-full text-sm font-medium transition-all duration-200"
                                                                        :class="mode === 'annonceur' ? 'bg-white text-blue-600 shadow' : 'text-gray-600 hover:text-gray-800'">
                                                                        Annonceur
                                                               </button>
                                                      </div>
                                             </div>
                                    ...
                                    <div class="flex items-center gap-4">
                                             ...
                                             <button
                                                      ...
                                                      <svg class="text-white color-white" width="22" height="22"
                                                               ...
                                                               <path d="M11 1V21" stroke="#808080" stroke-width="2"
                                                                        stroke-linecap="round"
                                                                        stroke-linejoin="round" />
                                                      </svg>
                                             ...
                                             <div class="relative notifications-dropdown" ref="notificationsRef">
                                                      ...
                                                      <div v-if="isNotificationsOpen"
                                                               ...
                                                               <div class="px-4 py-2 border-t border-gray-100">
                                                                        <a href="#"
                                                                                 class="text-sm text-blue-600 hover:text-blue-700 font-medium">Voir
                                                                                 toutes les
                                                                                 notifications</a>
                                                               </div>
                                                      </div>
                  ...
                  <div class="flex">
                           <!-- Sidebar -->
                           <aside class="fixed md:static inset-y-0 left-0 transform md:transform-none transition-all duration-200 ease-in-out z-30 bg-white h-[calc(100vh-4rem)] shadow-sm overflow-y-auto"
                                    :class="[
                                    ...
                                    <nav class="p-4 space-y-2">
                                             ...
                                             <NuxtLink to="/dashboard/messages"
                                                      ...
                                                      :class="[
                                                               { 'justify-center': isCollapsed },
                                                               $route.path === '/dashboard/messages' ? 'text-blue-600 bg-blue-50' : ''
                                                      ]">
