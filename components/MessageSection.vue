<template>
  <div class="bg-white rounded-xl shadow-sm">
    ...
    <div class="flex h-[calc(100vh-8rem)]">
      <!-- Conversations List -->
      <div
        class="w-full md:w-80 border-r border-gray-200 flex flex-col"
    ...
    messages: [
      {
        id: 1,
        content:
          "Quis cursus eros, morbi vitae aenean ante nibh a. Mi ornare vitae viverra risus senectus amet. Maecenas mattis in in odio imperdiet.",
        time: "5:10",
        isSent: false,
      },
      {
        id: 2,
        content:
          "Duis proin eu sagittis fermentum eget pharetra libero augue dui. Suscipit volutpat fames tincidunt.",
        time: "5:10",
        isSent: true,
      },
    ],
