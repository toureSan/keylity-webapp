<template>
         <div>
                  ...
                  <div class="bg-white rounded-xl shadow-sm p-4 md:p-6 mb-6 overflow-hidden">
                           <VueDatePicker v-model="selectedDate" :enable-time-picker="false" :week-start="1" locale="fr"
                                    :multi-calendars="isDesktop" :format="format" :month-change-on-scroll="false"
                                    :teleport="true" :teleport-center="true" auto-apply class="calendar-custom">
                                    <template #day-content="{ day }">
                                             <div class="day-content">
                                                      <span>{{ day.day }}</span>
                                                      <div class="events-dots">
                                                               <template v-for="event in getEventsForDate(day.value)"
                                                                        :key="event.id">
                                                                        <div class="event-dot"
                                                                                 :class="event.status === 'accepted' ? 'bg-green-400' : 'bg-red-400'"
                  ...
                  <div class="bg-white rounded-xl shadow-sm p-4 md:p-6">
                           ...
                           <div class="space-y-4">
                                    <div v-for="request in visitRequests" :key="request.id"
...
// Sample events data
const events = [
         { id: 1, date: new Date(), time: '09:00', name: 'Tamara', status: 'accepted' },
         { id: 2, date: new Date(), time: '10:00', name: 'Samuel', status: 'accepted' },
         { id: 3, date: new Date(), time: '10:00', name: 'Henry', status: 'pending' },
         { id: 4, date: new Date(), time: '14:00', name: 'Marianah', status: 'pending' }
]
