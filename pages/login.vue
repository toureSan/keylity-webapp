      ...
      <div class="mx-auto w-full max-w-sm lg:w-96">
        <div class="animate-fade-in"> 
          <NuxtLink to="/" class=" cursor-pointer">
            ...
            <img :src="logoImage" alt="Keylity" class=" cursor-pointer h-15 w-auto transform transition-transform duration-300 hover:scale-105" />
          </NuxtLink>
          ...
          <p class="mt-2 text-sm/6 text-gray-500">
            ...
            {{ ' ' }}
            <NuxtLink to="/register" class="font-semibold text-blue-600 hover:text-blue-500 transition-colors duration-300">
              Créer un compte
            </NuxtLink>
          </p>
        </div>
        ...
        <div class="mt-10">
          <div>
            <form @submit.prevent="handleLogin" class="space-y-6">
              <div class="group">
                <label for="email" class="block text-sm/6 font-medium text-gray-900 group-focus-within:text-blue-600 transition-colors duration-300">Adresse email</label>
              ...
              <div class="group">
                <label for="password" class="block text-sm/6 font-medium text-gray-900 group-focus-within:text-blue-600 transition-colors duration-300">Mot de passe</label>
                <div class="mt-2 relative">
                  <input 
                    v-model="password" 
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="text-sm/6">
                  <a href="#" class="font-semibold text-blue-600 hover:text-blue-500 transition-colors duration-300">Mot de passe oublié ?</a>
                </div>
              </div>
              ...
              <div>
                ...
                >
                  <span class="flex items-center">
                    Se connecter
                    <svg class="ml-2 h-5 w-5 transform transition-transform duration-300 group-hover:translate-x-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div class="mt-10">
            ...
            <div class="w-full mt-6">
              ...
              >
                <svg class="h-5 w-5 transform transition-transform duration-300 group-hover:scale-110" aria-hidden="true" viewBox="0 0 24 24">
