...
=======
  ...
  -->
         ...
         <div class="flex min-h-screen">
                           ...
                           <div class="mx-auto w-full max-w-sm lg:w-96">
                                    ...
                                    <div class="mt-10">
                                             <form @submit.prevent="handleRegister" class="space-y-6">
                                                      <div class="group">
                                                               <label for="email"
                                                                        class="block text-sm/6 font-medium text-gray-900">Adresse email</label>
                                                               <div class="mt-2 relative">
                                                      ...
                                                      <div class="group">
                                                               <label for="confirmPassword"
                                                                        class="block text-sm/6 font-medium text-gray-900">Confirmer le mot de passe</label>
                                                               <div class="mt-2 relative">
                                                      ...
                                                      <div>
                                                               <button type="submit"
                                                                        ...
                                                                        <span class="flex items-center">
                                                                                 Créer un compte
                                                                                 <svg class="ml-2 h-5 w-5 transform transition-transform duration-300 group-hover:translate-x-1"
                                                                                          xmlns="http://www.w3.org/2000/svg"
                                                                                          viewBox="0 0 20 20"
                                                                                          fill="currentColor">
                                                                                          <path fill-rule="evenodd"
                  ...
                  <div class="relative hidden flex-1 lg:block">
                           <!-- Image floutée -->
                           <img class="absolute inset-0 w-full h-full object-cover" src="@/assets/images/famille.png"
